    ...
    >
      ...
      <div className='card'>
        ...
        >
          ...
          >
            • <strong>Win:</strong> Gain opponent&apos;s mana wager
            <br />• <strong>Lose:</strong> Lose your mana wager
            <br />• <strong>Draw:</strong> Keep your mana
          </div>
        </div>
      </div>
      ...
      <div className='card'>
        ...
        >
          ...
          >
            ...
            <br />• Lose 500 mana with Epic elemental &rarr; Keep 200 mana (40%
            protected)
          </div>
        </div>
      </div>
      ...
      <div className='card'>
        ...
        >
          ...
          >
            <span style={{ fontSize: '2rem' }}>⭐</span>
            <div>
              <div style={{ color: 'var(--secondary-gold)', fontWeight: 600 }}>
                Experience & Levels
              </div>
              <div style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>
          ...
          >
            ...
            <div>
              ...
              <div style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>
                Novice &rarr; Adept &rarr; Expert &rarr; Master • Earn special
                titles
              </div>
            </div>
          </div>
